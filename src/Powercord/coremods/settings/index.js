...
/*
async function patchSettingsContextMenu () {
  ...
  inject('pc-settings-actions', SettingsContextMenu, 'default', (_, res) => {
    ...
    if (changelog) {
      ...
      console.error('Unable to locate "Change Log" item; forcing element to context menu!');
...
module.exports = async () => {
  ...
  loadStyle(resolve(__dirname, 'scss/style.scss'));
